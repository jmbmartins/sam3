...
TEXT_PROMPT = "trash on the ground near the container"
OUTPUT_PATH = "/home/evox5090ia/sam3/sam3_outputs/image1_output.png"
CONF_THRESH = 0.05
# -----------------------------------
...
def main():
    ...
    print(f"\nAfter confidence filtering (>{CONF_THRESH}): {len(detections)} detections")

    if len(detections) == 0:
        print("No detections above threshold; nothing to annotate.")
        return
