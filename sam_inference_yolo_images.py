...
#         CONFIG
# =========================
INPUT_DIR = Path("/datasets/suma_sao_joao_da_madeira/images")  # folder with images
OUTPUT_DIR = Path("/datasets/suma_sao_joao_da_madeira/possible_postes")
